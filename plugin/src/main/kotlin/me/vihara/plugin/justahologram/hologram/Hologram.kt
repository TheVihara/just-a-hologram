...
data class Hologram(val id: String, val position: Hologram.Position, val lines: HashSet<HologramLine>, val properties: PropertyMap) : Hologram {
    var lastTick = 0
    ...
    override fun position(): Hologram.Position {
        return position
    }
